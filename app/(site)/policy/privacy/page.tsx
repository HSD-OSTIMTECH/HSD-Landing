  ...
  <section className="max-w-7xl mx-auto py-20 px-4 flex flex-col gap-10">
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-neutral-400 text-lg text-center max-w-2xl mt-2">
        Gizliliğiniz bizim için önemlidir. Bu politika, hangi bilgileri
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        <div className="flex items-center gap-3 mb-2">
          <Icon
            icon="hugeicons:square-arrow-down-double"
            className="text-primary text-2xl"
          />
          <h2 className="text-xl font-semibold text-white">Bilgi Kullanımı</h2>
        </div>
        <p className="text-neutral-300">
          Toplanan bilgiler yalnızca iletişim, hizmet geliştirme ve kullanıcı
          deneyimini iyileştirme amacıyla kullanılır.
        </p>
      </div>
      {/* Üçüncü Taraflarla Paylaşım */}
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        <div className="flex items-center gap-3 mb-2">
          <Icon icon="hugeicons:user-group" className="text-primary text-2xl" />
          <h2 className="text-xl font-semibold text-white">
            Üçüncü Taraflarla Paylaşım
          </h2>
        </div>
        <p className="text-neutral-300">
          Kişisel bilgileriniz izniniz olmadan üçüncü taraflarla paylaşılmaz.
      ...
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        ...
        <p className="text-neutral-300">
          Verilerinizin güvenliği için teknik ve idari önlemler alınmaktadır.
          Ancak internet üzerinden iletilen verilerin tam güvenliği garanti
          edilemez.
        </p>
      </div>
    </div>
