...
const Terms = () => (
  <section className="max-w-7xl mx-auto py-20 px-4 flex flex-col gap-10">
    <div className="flex flex-col items-center gap-2">
      ...
      />
      <h1 className="text-4xl sm:text-5xl font-advent-pro font-bold text-center">
        Kullanım Şartları
      </h1>
      <p className="text-neutral-400 text-lg text-center max-w-2xl mt-2">
        Web sitemizi kullanmadan önce lütfen bu şartları dikkatlice okuyunuz.
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        <div className="flex items-center gap-3 mb-2">
          <Icon icon="hugeicons:shield-01" className="text-primary text-2xl" />
        ...
        <ul className="list-disc list-inside text-neutral-300 space-y-2">
          ...
          <li>
            Diğer kullanıcıların haklarına ve gizliliğine saygı gösterilmelidir.
          </li>
        </ul>
      </div>
      {/* Fikri Mülkiyet */}
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        ...
        <p className="text-neutral-300">
          Site üzerindeki tüm içeriklerin (metin, görsel, logo, tasarım vb.)
          hakları saklıdır. İzinsiz kullanılamaz, kopyalanamaz veya
          çoğaltılamaz.
        </p>
      </div>
      {/* Sorumluluk Reddi */}
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        ...
        <p className="text-neutral-300">
          Site içeriği yalnızca bilgilendirme amaçlıdır. Sunulan bilgilerin
          doğruluğu ve güncelliği garanti edilmez. Kullanıcılar, sitedeki
          bilgilere dayanarak aldıkları kararlardan kendileri sorumludur.
        </p>
      </div>
      ...
      <div className="bg-neutral-900 rounded-2xl border border-neutral-800 shadow-lg p-8 flex flex-col gap-4">
        ...
        <p className="text-neutral-300">
          Kullanım şartları önceden haber verilmeksizin değiştirilebilir.
