...
const About = () => {
    ...
    return (
        <section className='my-24 max-w-7xl container mx-auto flex flex-col items-start gap-12'>
            <section className="max-w-7xl container mx-auto flex flex-col md:flex-row items-center justify-between relative gap-8 md:gap-0">
                <h1 className="text-3xl sm:text-5xl md:text-7xl font-advent-pro font-semibold">
                    Biz Kimiz, Ne Yapıyoruz?
                </h1>

                <div className="max-w-2xl flex flex-col items-start gap-2">
            ...
            <section className="w-full flex flex-col gap-8 my-36">
                <div className="flex flex-col md:flex-row items-center justify-between w-full gap-4">
                    <h2 className="text-3xl sm:text-4xl font-advent-pro font-bold text-white">Ekibimizle Tanış!</h2>
            ...
            <section className="max-w-7xl container mx-auto flex flex-col md:flex-row items-center justify-between relative gap-8 md:gap-0 my-24">
                <div className="max-w-2xl flex flex-col items-start gap-2">
                    <p className="text-lg">
                ...
                <h1 className="text-right text-3xl sm:text-5xl md:text-7xl font-advent-pro font-semibold max-w-lg">
