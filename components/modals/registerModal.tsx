...
// Artık stepVariants kullanılmayacak, sade fade animasyon olacak
        ...
        <div className="fixed inset-0 w-full h-full flex items-center justify-center z-50 bg-black/80 backdrop-blur-xl">
            ...
            >
                ...
                <div className="flex flex-col items-center gap-1 mt-2">
                    <span className="text-neutral-300 text-sm">Zaten Kayıt Oldun mu? <a href="#" className="text-sky-400 hover:underline" onClick={e => { e.preventDefault(); if (onOpenLogin) onOpenLogin(); }}>Hemen Giriş Yap!</a></span>
                </div>
            </motion.div>
        </div>
    );
