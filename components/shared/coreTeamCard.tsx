...
const CoreTeamCard = () => {
    return (
        <motion.div
            className="w-72 h-72 perspective cursor-pointer"
        >
            <motion.div
                ...
                <div className="absolute w-full h-full bg-gradient-to-b from-primary to-secondary text-white p-4 rounded-md backface-hidden transform rotateY-180 flex flex-col justify-center items-center gap-2 text-center">
                    ...
                    <div className="flex gap-4 mt-2">
                        <a href="#" target="_blank" rel="noopener noreferrer">
                            <Icon icon="hugeicons:instagram" className="text-2xl hover:rotate-[360deg] transition-all duration-300" />
                        </a>
                        <a href="#" target="_blank" rel="noopener noreferrer">
                            <Icon icon="hugeicons:medium-square" className="text-2xl hover:rotate-[360deg] transition-all duration-300" />
                        </a>
                        <a href="#" target="_blank" rel="noopener noreferrer">
                            <Icon icon="hugeicons:linkedin-01" className="text-2xl hover:rotate-[360deg] transition-all duration-300" />
                        </a>
                    </div>
                </div>
            </motion.div>
